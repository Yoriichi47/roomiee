...
import { newRoom } from "@/app/data/RoomDataFunctions";
...
export default function NewRoomPage() {
  ...
  const onSubmit = async (data: FormValues) => {
    ...
    try {
      console.log("Sending to newRoom:", data);

      const result = await newRoom(data);
      
      console.log("Result from newRoom:", result);
                ...
                >
                        ...
                        <FormControl>
                          ...
                          >
                            <div className="flex items-center gap-3">
                              ...
                              <Label htmlFor="ac-yes" className="cursor-pointer">
                                Yes
                              </Label>
                            </div>
                            <div className="flex items-center gap-3">
                        ...
                        <FormControl>
                          ...
                          >
                            <div className="flex items-center gap-3">
                              ...
                              <Label htmlFor="wf-yes" className="cursor-pointer">
                                Yes
                              </Label>
                            </div>
                            <div className="flex items-center gap-3">
                        ...
                        <FormControl>
                          ...
                          >
                            <div className="flex items-center gap-3">
                              ...
                              <Label htmlFor="bf-yes" className="cursor-pointer">
                                Yes
                              </Label>
                            </div>
                            <div className="flex items-center gap-3">
                  ...
                  <div className="col-span-2">
                    <Button
                      ...
                      disabled={form.formState.isSubmitting}
                    >
                      {form.formState.isSubmitting ? "Creating Room..." : "Submit"}
                    </Button>
                  </div>
                </fieldset>
              </form>
