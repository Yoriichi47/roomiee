              ...
              <CardContent className="">
                <Table>
                  <TableBody>
                    ...
                    <Button className="bg-zinc-600 hover:bg-zinc-800 transition-all"><Link href={`/admin/bookings/invoice?booking=${data?.booking.bookingId}`}>View Invoice</Link></Button>
              </CardContent>
            </Card>
          </CardContent>
        </Card>
